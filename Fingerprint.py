...
class Fingerprint:
    ...
    def init_from_response(self, ecn_sender, open_ports_sender, udp_sender, icmp_sender, probe_sender,
        ...
        self.T1.init_from_response(open_ports_sender)
        self.T2.init_from_response(open_ports_sender)
        self.T3.init_from_response(open_ports_sender)
        self.T4.init_from_response(open_ports_sender)
        self.T5.init_from_response(close_ports_sender)
        self.T6.init_from_response(close_ports_sender)
        self.T7.init_from_response(close_ports_sender)
