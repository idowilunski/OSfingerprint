...
class Fingerprint:
    ...
    def init_from_response(self, ecn_sender, open_ports_sender, udp_sender, icmp_sender, probe_sender,
        ...
        self.T1.init_from_response(open_ports_sender, open_ports_sender.get_checks_list()[0])
        self.T2.init_from_response(open_ports_sender, open_ports_sender.get_checks_list()[1])
        self.T3.init_from_response(open_ports_sender, open_ports_sender.get_checks_list()[2])
        self.T4.init_from_response(open_ports_sender, open_ports_sender.get_checks_list()[3])
