...
#TODO make sure all tests has "target_port" set to  open/close according to documentation!!!!!!!!
...
# Prepares T2-T7 packets according to the following documentation, under "TCP (T2–T7)":
